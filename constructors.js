...
User.prototype.removeSavedPost = function(id) {
  this.savedPosts = this.savedPosts.filter(id => id !== id);
  this.savedPosts.splice(1, id);
};
...
User.prototype.changePostRating = function(id, rating) {
  this.savedPosts = this.savedPosts.findIndex(post => post.id === id);
  this.savedPosts.id.rating = rating;
};
